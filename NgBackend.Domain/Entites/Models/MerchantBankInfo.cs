...
namespace NgBackend.Domain.Entites.Models
{
    ...
    public class MerchantBankInfo 
    {
        ...
        //     var merchantBankInfo = obj as MerchantBankInfo;
        //     if (merchantBankInfo?.Id == null || merchantBankInfo?.Id == 0 || Id == 0) return false;
        //     return EqualityComparer<long>.Default.Equals(Id, merchantBankInfo.Id);
        // }
