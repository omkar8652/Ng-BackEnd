...
{
    [Table("mst_business_entity_type")]
    public class MstBusinessEntityType 
    {
        [Key]
        ...
        //     var mstBusinessEntityType = obj as MstBusinessEntityType;
        //     if (mstBusinessEntityType?.Id == null || mstBusinessEntityType?.Id == 0 || Id == 0) return false;
        //     return EqualityComparer<long>.Default.Equals(Id, mstBusinessEntityType.Id);
        // }
